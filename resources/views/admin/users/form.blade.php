...
<div class="recruiter_inputs" style="display: none;">
    ...
    @include('form.select',['name'=>'is_verified','options'=>['1'=>trans('app.Yes'),'0'=>trans('app.No')],'attributes'=>['class'=>'form-control','label'=>trans('app.Is verified'),'placeholder'=>trans('app.Is verified'),'id'=>'is_verified']])
</div>
