...
class AdminUsersWithTypeEmployeeTest extends TestCase {
    ...
    public function test_post_create() {
        dump(get_class($this) . ' ' . __FUNCTION__);
        $this->actingAsAdmin();
        $factory = \App\Models\User::factory()->make(['type'=>'employee']);
    ...
    public function test_get_edit() {
        dump(get_class($this) . ' ' . __FUNCTION__);
        $this->actingAsAdmin();
        $record = \App\Models\User::factory()->create(['type'=>'employee']);
