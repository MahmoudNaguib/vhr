    ...
    <?php if(can('view-'.$module)): ?>
        ...
        <?php if(!$rows->isEmpty()): ?>
            ...
            <div class="grid-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th class="ml-2"><?php echo e(trans('app.Code')); ?> </th>
                    ...
                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td data-label="<?php echo e(trans('app.Code')); ?>">
                                <?php echo e($row->code); ?>
            ...
            <div class="d-flex justify-content-center">
                <?php echo $rows->appends(['title'=>request('title'),'code'=>request('code')])->links(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/vhr/resources/views/admin/countries/index.blade.php ENDPATH**/ ?>