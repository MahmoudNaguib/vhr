    ...
    <?php if(can('view-'.$module)): ?>
        ...
        <?php if(!$rows->isEmpty()): ?>
            ...
            <div class="d-flex justify-content-center">
                <?php echo $rows->appends(['name'=>request('name'),'email'=>request('email'),'mobile'=>request('mobile')])->links(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/vhr/resources/views/admin/messages/index.blade.php ENDPATH**/ ?>