...
<?php echo $__env->make('form.input',['name'=>'users_count','type'=>'number','attributes'=>['class'=>'form-control','label'=>trans('app.Users count'),'placeholder'=>trans('app.Users count'),'autocomplete'=>"off",'step'=>'1','required'=>1,'min'=>1]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->make('form.input',['name'=>'unlock_count','type'=>'number','attributes'=>['class'=>'form-control','label'=>trans('app.Unlock count'),'placeholder'=>trans('app.Unlock count'),'autocomplete'=>"off",'step'=>'1','required'=>1,'min'=>1]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
