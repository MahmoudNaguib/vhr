                    ...
                    <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td data-label="<?php echo e(trans('app.Posts count')); ?>">
                                <?php echo e($row->posts_count); ?>

                            </td>
                            <td data-label="<?php echo e(trans('app.Duration in month')); ?>">
                                <?php echo e($row->duration_in_month); ?> <?php echo e(trans('app.Months')); ?>

                            </td>
                            <td data-label="<?php echo e(trans('app.Price')); ?>">
                                <?php echo e($row->price); ?> <?php echo e(trans('app.EGP')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/vhr/resources/views/admin/plans/index.blade.php ENDPATH**/ ?>