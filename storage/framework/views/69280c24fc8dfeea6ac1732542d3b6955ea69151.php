...
<?php echo $__env->make('form.select',['name'=>'plan_id','options'=>$row->getPlans(),'attributes'=>['class'=>'form-control','label'=>trans('app.Plan'),'placeholder'=>trans('app.Plan'),'required'=>1]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->make('form.input',['name'=>'expiry_date','type'=>'text','attributes'=>['class'=>'form-control datepicker','label'=>trans('app.Expiry date'),'placeholder'=>trans('app.Expiry date'),'autocomplete'=>"off",'required'=>1]], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /opt/lampp/htdocs/vhr/resources/views/admin/companies/form.blade.php ENDPATH**/ ?>