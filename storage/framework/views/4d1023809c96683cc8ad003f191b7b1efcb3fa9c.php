<div class="mt-2 mb-3">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 mt-2">
            <?php echo Form::select('type', $row->getTypes(),@request('type'), ['class'=>'form-control','placeholder'=>trans('app.Select type')]); ?>
...
<?php /**PATH /opt/lampp/htdocs/vhr/resources/views/admin/users/partials/filters.blade.php ENDPATH**/ ?>